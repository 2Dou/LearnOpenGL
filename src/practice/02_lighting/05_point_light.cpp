...
PointLight::PointLight() : delegate_(this, &PointLight::ProcessInput) {
}

PointLight::~PointLight() {
}

void PointLight::Attached() {
    // 隐藏光标
...
void PointLight::Init() {
    ...
    light_shader_.Compile(util::GetResourceFilename("shaders/02_lighting/05_point_light/light.vs")
                    , util::GetResourceFilename("shaders/02_lighting/05_point_light/light.fs"));

    object_shader_.Compile(util::GetResourceFilename("shaders/02_lighting/05_point_light/object.vs")
                    , util::GetResourceFilename("shaders/02_lighting/05_point_light/object.fs"));
    ...
    object_shader_.Use();
    object_shader_.SetVec3("light.position", glm::value_ptr(light_pos));
...
void PointLight::Position(double xpos, double ypos) {
...
void PointLight::Scroll(double xoffset, double yoffset) {
